...
export async function saveTaskToDb(t: Partial<TaskItem>): Promise<string> {
  ...
  try {
    ...
    const payload: any = {
      ...
      taskImage: t.taskImage || t.taskImageUrl || '',
      taskImageUrl: t.taskImageUrl || t.taskImage || '',
      description: t.description || '',
      detailedInstructions: t.detailedInstructions || t.description || '',
      proofDemoImage: t.proofDemoImage || t.proofDemoImageUrl || '',
      proofDemoImageUrl: t.proofDemoImageUrl || t.proofDemoImage || '',
